...
<body>
    ...
    <div class="flex flex-wrap demobist-container demobist-gradient wave" style=" border-radius:0 0 300px 0;">
        <div class="w-3/5 mt-5">
            ...
            <div class="demobist-inceleme flex mt-16 justify-items-start gap-16">
                <a href="#"
                    class="inline-block font-bold bg-white border rounded-md px-16 py-4 flex items-center justify-center text-decoration-none">
                    HEMEN BAŞLA
                </a>
                <a href="#"
                    class="inline-block border border-white rounded-md px-16 py-4 flex items-center justify-center text-white hover:bg-white hover:text-black hover:border-transparent transition-all duration-300">
                    DETAYLI İNCELE
                </a>
            </div>
        </div>
    ...
    <div class="row pt-20 pb-20 text-center demobist-kullanici-sayisi">
    ...
    <div class="demobist-container text-center flex flex-row-reverse flex-wrap">
        <div class="w-1/2">
            ...
            <a href="#"
                class="demo-bist-bg demobist-hover ml-5 mr-5 text-white border rounded-md px-16 py-4 flex items-center justify-center text-decoration-none">
                SORU SOR
            </a>
        </div>
    ...
    <div class="demobist-container demo-bist-bg text-center flex text-white  flex-wrap">
        <div class="w-1/2">
    ...
    <div class="demobist-container">
        <h3 class="text-3xl text-center font-bold">Sık Sorulan Sorular</h3>
        <?php include("sorular.html"); ?>
    </div>

    <div class="demobist-container demo-bist-bg bg-white text-white">
        <div>
            <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-center text-white">İletişim
            </h2>
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Teknik bir sorun
            ...
            <form action="#" class="space-y-8">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="message" rows="6"
                        ...
                        placeholder="İletiniz"></textarea>
                </div>
                <button type="submit"
                    class="demo-bist-bg w-full demobist-hover text-white border rounded-md px-16 py-4 flex items-center justify-center text-decoration-none">
                    GÖNDER</button>
            </form>
        </div>
    </div>
