...
body {
    ...
    width: 100%;
    place-items: center;
    background: -webkit-linear-gradient(left, #00a4bd, #6bc8d6);
...
form .btn .btn-layer {
    ...
    background: -webkit-linear-gradient(right, #a445b2, #00a4bd, #a445b2, #6bc8d6);
    border-radius: 5px;
            ...
            <div class="form-inner">
                <form action="#" class="login">
                    ...
                    <div class="signup-link">
                        Hesabın yok mu? <a href="">Hemen kaydol</a>
                    </div>
                </form>
