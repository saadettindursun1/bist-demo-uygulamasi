...
<body class="g-sidenav-show  bg-gray-200">
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            <div
                                ...
                                <i class="material-icons opacity-10">currency_lira</i>
                            </div>
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">BIST 100 Endeksi</p>
                                <h4 class="mb-0">9.079</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+3,15% </span>günlük
                                değişim.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Cüzdanım</p>
                                <h4 class="mb-0"><?php echo $_SESSION["amount"]; ?></h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+32% </span> değişim.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Sıralama</p>
                                <h4 class="mb-0">195</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+10</span> yükseliş.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">İşlem Sayısı</p>
                                <h4 class="mb-0">121</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class=" text-sm font-weight-bolder">14</span>işlem bu hafta.
            ...
            <div class="row mt-4">
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">BIST 100 Grafiği</h6>
                            <p class="text-sm ">Borsa İstanbul Endeksi Grafiği</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p class="mb-0 text-sm">1 gün önce güncellendi.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2  ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 "> Kişisel Grafik </h6>
                            <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) net artış/azalış.
                            </p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                ...
                <div class="col-lg-4 mt-4 mb-3">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">Demobist Liderlik Tablosu</h6>
                            <p class="text-sm ">9 aylık sıralama istatistiği.</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p class="mb-0 text-sm">12 saat önce güncellendi.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header pb-0">
                            <div class="row">
                                <div class="col-lg-6 col-7">
                                    <h6>Portföyümdeki Hisseler</h6>
                                    <p class="text-sm mb-0">
                                        <i class="fa fa-check text-info" aria-hidden="true"></i>
                                        <span class="font-weight-bold ms-1">anlık veriler</span> gösteriliyor.
                                    </p>
                                </div>
    ...
    new Chart(ctx, {
        type: "bar",
        data: {
            labels: ["Eylül", "Ekim", "Kasım", "Aralık", "Ocak", "Şubat", "Mart"],
            datasets: [{
                label: "Sales",
                tension: 0.4,
                borderWidth: 0,
    ...
    new Chart(ctx2, {
        type: "line",
        data: {
            labels: ["Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık", "Ocak", "Şubat", "Mart"],
            datasets: [{
                label: "Mobile apps",
                tension: 0,
                borderWidth: 0,
