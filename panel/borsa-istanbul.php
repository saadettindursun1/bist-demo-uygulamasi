                        ...
                        <div class="modal-body">
                            ...
                            <div id="buyForm">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <input type="text" class="form-control stock-input stock_name" id="buy_stock_name"
                                        readonly>
                                </div>
                                <div class=" mb-3">
                                    <label class="form-label">Fiyat</label>
                                    <input type="text" class="form-control stock-input stock_value" id="buy_stock_value"
                                        readonly>
                                </div>
                                ...
                                <div class=" mb-3">
                                    ...
                                    <br>
                                    Kullanılabilir Bakiye : <label
                                        id="user_amount"><?php echo $_SESSION["amount"]; ?></label>
                                </div>
                                <button type="button" id="buy_stock_btn" class="btn btn-primary btn-block w-100"
                                    onclick="buy_sell_stock_func('buy')" disabled>Satın Al</button>
                            </div>
                            ...
                            <div id="sellForm" class="hidden">
                                <div class=" mb-3">
                                    <label class="form-label">Hisse Adı</label>
                                    <input type="text" class="form-control stock-input stock_name" id="sell_stock_name"
                                        readonly>
                                </div>
                                <div class=" mb-3">
                                    <label class="form-label">Fiyat</label>
                                    <input type="text" class="form-control stock-input  stock_value"
                                        id="sell_stock_value" readonly>
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                    <label class="form-label">Adet</label>
                                ...
                                <button type="button" id="sell_stock_btn" class="btn btn-warning btn-block w-100"
                                    onclick="buy_sell_stock_func('sell')" disabled>Satış
                                    Gerçekleştir</button>
                            </div>
                        </div>
    ...
    function buy_sell_stock_func(process) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                let userAmount = Number($('#user_amount').text());
                let available_qty = Number($('#available_qty').text());
                let totalAmount = Number(total);
                let updateQty = Number(qty);

                if (process == "sell") {
                    // Satış işlemi için toplama
                    $('#user_amount').text(userAmount + totalAmount);
                    $('#available_qty').text(available_qty - updateQty);
                } else {
                    // Diğer işlemler için çıkarma
                    $('#user_amount').text(userAmount - totalAmount);
                    $('#available_qty').text(available_qty + updateQty);
